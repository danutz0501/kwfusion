...
class Validate{
	...
	public static function filter_input(array $data, array $filters)
	{
		...
		return $validate->filter($data, $filters);
	}
		...
		foreach($this->errors as $e) {
			...
			switch($e['rule']) {
				...
				case 'validate_min_len':
					...
					break;
				case 'validate_matches':
					if($param == 1) {
						$resp[] = "The <span class=\"$field_class\">$field</span> field does not match the $param field";
					} else {
						$resp[] = "The <span class=\"$field_class\">$field</span> field does not match the $param field";
					}
					break;
	...
	*/
	 ...
	 *
	 * See: https://github.com/Wixel/validate/issues/5
